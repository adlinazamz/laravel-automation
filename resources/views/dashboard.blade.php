    ...
    <div class="min-h-screen py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
                    <h5 class="text-gray-500 dark:text-gray-400 mb-2">Total Revenue</h5>
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">$5,430</p>
                </div>
            </div>

            <!-- Charts -->
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Line chart: Product Created Over Time -->
                <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
                    <h5 class="text-gray-500 dark:text-gray-400 mb-4">Products Created Over Time</h5>
                    <div id="line-chart-products" class="h-80"></div>
                </div>

                <!-- Donut chart: Product Type Distribution -->
                <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
                    <h5 class="text-gray-500 dark:text-gray-400 mb-4">Product Type Distribution</h5>
    ...
    <div class="grid gap-4 grid-cols-2">
      <div>
        <h5 class="inline-flex items-center text-gray-500 dark:text-gray-400 leading-none font-normal mb-2">Clicks
           <div id="line-chart-clicks" class="h-80"></div>
