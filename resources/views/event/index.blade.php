...
<div class="bg-gray-50 dark:bg-gray-900 p-6 min-h-screen">
    <div class="max-w-screen-xl mx-auto">
        ...
        <div class="flex-grow overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 rounded-lg">
...
<td class="border px-4 py-2 text-sm text-gray-800">
            {{ $event->updated_at }}
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-6 text-center text-gray-400">No {{ strtolower($modelName) }} found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
