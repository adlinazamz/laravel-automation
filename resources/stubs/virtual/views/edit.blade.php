...
<div class="max-w-2xl mx-auto mt-10 bg-white shadow-md rounded-lg">
  <h2 class="text-xl font-semibold bg-gray-100 px-6 py-4 rounded-t-lg">Edit {{$modelName}}</h2>
  <div class="px-6 py-4">
    ...
    <form action="{{route('virtual.update', ['table'=>$modelNameLower, 'id'=>$id])}}" method="POST" enctype="multipart/form-data">
      @csrf
      @method('PUT')
    {!! $formFields !!}
